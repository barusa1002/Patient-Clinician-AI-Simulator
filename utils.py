...
_DRUG_URL_MAP = {
    ...
    "アスピリン":        _pack("3399007H1137_1_07"),   # 後発「ZE」腸溶錠
    # ── 循環器 ──
    "アムロジピン":      _pack("2171022F1282_1_21"),   # 後発「サワイ」
    "カンデサルタン":    _pack("2149040F1093_1_11"),   # 後発「JG」
    "バルサルタン":      _pack("2149041F1292_1_05"),   # 後発「日新」
    "エナラプリル":      _pack("2144002F1210_1_14"),   # 後発「JG」
    "カルベジロール":    _pack("2149032F1102_2_01"),   # 後発「タナベ」
    "ビソプロロール":    _pack("2123016F1174_1_05"),   # 後発「JG」
    "フロセミド":        _pack("2139005F1060_4_14"),   # 後発「NP」
    "スピロノラクトン":  _pack("2133001F1603_4_01"),   # 後発「YD」
    "エプレレノン":      _pack("2149045F1037_1_02"),   # 後発「杏林」
    ...
    "酸化マグネシウム":  _pack("2344009F1086_1_07"),   # 後発「ケンエー」
    # ── 糖尿病・代謝 ──
    "メトホルミン":      _pack("3962002F2124_1_06"),   # 後発「DSPB」
    "グリメピリド":      _pack("3961008F1217_1_10"),   # 後発「サワイ」
    "インスリングラルギン": _pack("2492416G2024_1_16"), # ランタス
    "ランタス":          _pack("2492416G2024_1_16"),
    # ── 脂質異常 ──
    "アトルバスタチン":  _pack("2189015F1082_1_15"),   # 後発「DSEP」
    "ロスバスタチン":    _pack("2189017F1154_1_03"),   # 後発「サワイ」
    "フェノフィブラート": _pack("2183006F3040_1_05"),  # 後発「武田テバ」
    # ── 呼吸器 ──
    "ブデソニド":        _pack("2290801G1029_1_17"),   # シムビコート（ブデソニド・ホルモテロール配合）
    "シムビコート":      _pack("2290801G1029_1_17"),
    ...
    # ── 抗菌 ──
    "クラリスロマイシン": _pack("6149003F2054_2_25"),  # 後発「EMEC」
    # ── アレルギー ──
    ...
    "プレガバリン":      _pack("1190017F1185_1_01"),   # 後発「トーワ」
